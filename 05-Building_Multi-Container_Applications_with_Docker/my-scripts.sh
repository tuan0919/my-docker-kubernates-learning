...
docker run -p 80:80 --network goal-network --name goal-backend -v app/node_modules -v "C:\Users\Tuan\Desktop\my-docker-kubernates-learning\05-Building_Multi-Container_Applications_with_Docker\backend:/app" goal-node:latest
...
docker run -p 3000:3000 -it --network goal-network --name goal-frontend -v app/node_modules -v "C:\Users\Tuan\Desktop\my-docker-kubernates-learning\05-Building_Multi-Container_Applications_with_Docker\frontend:/app" goal-react:latest
